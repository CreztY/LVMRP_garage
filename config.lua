...
Config.Price		= 300 -- pound price to get vehicle back
...
Config.Garages = {
	Garage_Centre = {
		...
		Camera = {
			pos = { x = 223.77, y = -807.48, z = 34.59, rotX = -30.40, rotY = 0.0, rotZ = 0.75 }
		},
	},
	Garage_NightClub = {
	...
	Garage_Gym = {
		Pos = {x = -1185.57,y = -1507.9,z = 4.4 },
		Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		Name = _U('garage_name'),
		HelpPrompt = _U('open_car_garage'),
		SpawnPoint = {
			Pos = {x = -1192.76,y = -1491.39,z = 4.4 },
			Heading = 144.887,
			Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			HelpPrompt = _U('spawn_car')
		},
		DeletePoint = {
			Pos = {x = -1194.05,y = -1499.76,z = 4.39 },
			Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			HelpPrompt = _U('store_car')
		}, 	
	},
	...
	Garage_mirrorpark = {
	 ...
	 Garage_Grapeseed = {
		 Pos = {x = 1702.93,y = 4796.66,z = 41.88 },
		 Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		 Name = _U('garage_name'),
		 HelpPrompt = _U('open_car_garage'),
		 Functionmenu = OpenMenuGarage,
		 SpawnPoint = {
			 Pos = {x = 1702.19,y = 4804.73,z = 41.83 },
			 Heading = 94.00,
			 Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			 HelpPrompt = _U('spawn_car'),
		 ...
		 DeletePoint = {
			 Pos = {x = 1692.51,y = 4785.07,z = 41.93 },
			 Marker = { w= 1.5, h= 1.0,r=255,g=0,b=0},
			 HelpPrompt = _U('store_car'),
	 ...
	 Garage_Pantalla = {
		 Pos = {x = -1635.06,y = -830.36,z = 10.15 },
		 Marker = { w= 1.5, h= 1.0,r = 204, g = 204, b = 0},
		 Name = _U('garage_name'),
		 HelpPrompt = _U('open_car_garage'),
		 Functionmenu = OpenMenuGarage,
		 SpawnPoint = {
			 Pos = {x = -1648.04,y = -829.11,z = 10.3 },
			 Heading = 239.90,
			 Marker = { w= 1.5, h= 1.0,r=0,g=255,b=0},
			 HelpPrompt = _U('spawn_car'),
			 Functionmenu = ListVehiclesMenu,
