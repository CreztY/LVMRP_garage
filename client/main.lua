	...
	ESX.TriggerServerCallback('eden_garage:getVehicles', function(vehicles)
		...
		function(data, menu)
			if data.current.value ~= "nocar" then
				...
				cachedData = CreateCam("DEFAULT_SCRIPTED_CAMERA", true)
				SetCamCoord(cachedData, garage_name.Camera.x, garage_name.Camera.y, garage_name.Camera.z)
				SetCamRot(cachedData, garage_name.Camera.rotX, garage_name.Camera.rotY, garage_name.Camera.rotZ)
				SetCamActive(cachedData, true)
